        ...
        <section id="main-content" className="relative min-h-screen bg-black flex items-center overflow-hidden" role="banner" aria-label="Hero section">
            ...
            <div className="hidden lg:block absolute right-12 xl:right-20 top-1/2 -translate-y-1/2 z-10">
                <div className={`flex flex-col items-center gap-4 transition-all duration-1000 delay-1000 ${showContent ? "opacity-100" : "opacity-0"}`}>
                    ...
                    <a href="https://github.com/Vedangm005" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://linkedin.com/in/vedang-mishra" target="_blank" rel="noopener noreferrer"
                        className="text-white/30 hover:text-white/70 transition-colors duration-300">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
